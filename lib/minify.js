...
var to_ascii = typeof Buffer == "undefined" ? atob : function(b64) {
    return Buffer.from(b64, "base64").toString();
};
var to_base64 = typeof Buffer == "undefined" ? btoa : function(str) {
...
function parse_source_map(content) {
    try {
        ...
        var preview = typeof content == "string" && content.length > 100
            ? content.slice(0, 100) + "..."
            : content;
        throw new Error("invalid input source map: " + preview);
    }
}
